        ...
        return (
            ...
            <section className='search-conteiner'>
                <article className='search-input-conteiner'>
                    ...
                    <input type="text" value={search} onChange={(e)=> setSearch(e.target.value)} name="search" id="search-input" className="search-input" placeholder='Buscar por titulo ou autor...'/>
                </article>
